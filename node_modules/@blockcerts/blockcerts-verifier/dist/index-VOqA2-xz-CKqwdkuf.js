 ...
 * Copyright (c) 2021 Digital Bazaar, Inc. All rights reserved.
 */
e.exports={SECURITY_CONTEXT_V1_URL:"https://w3id.org/security/v1",SECURITY_CONTEXT_V2_URL:"https://w3id.org/security/v2",CONTEXT_URL:"https://w3id.org/security/v2"}}]))}(i={exports:{}},i.exports),i.exports),c=(a=s)&&a.__esModule&&Object.prototype.hasOwnProperty.call(a,"default")?a.default:a,p=s.contexts,d=s.constants,u=s.CONTEXT,f=s.CONTEXT_URL,l=s.SECURITY_CONTEXT_V1_URL,h=s.SECURITY_CONTEXT_V2_URL,y=t(Object.freeze({__proto__:null,CONTEXT:u,CONTEXT_URL:f,SECURITY_CONTEXT_V1_URL:l,SECURITY_CONTEXT_V2_URL:h,constants:d,contexts:p,default:c}));
/*!
 * Copyright (c) 2017-2023 Digital Bazaar, Inc. All rights reserved.
 */
const{constants:m}=y;var w={SECURITY_CONTEXT_URL:m.SECURITY_CONTEXT_V2_URL,SECURITY_CONTEXT_V1_URL:m.SECURITY_CONTEXT_V1_URL,SECURITY_CONTEXT_V2_URL:m.SECURITY_CONTEXT_V2_URL,SECURITY_PROOF_URL:"https://w3id.org/security#proof",SECURITY_SIGNATURE_URL:"https://w3id.org/security#signature"};
/*!
 * Copyright (c) 2017-2023 Digital Bazaar, Inc. All rights reserved.
 */const g=w,{contexts:v}=y;
/*!
 * Copyright (c) 2018-2021 Digital Bazaar, Inc. All rights reserved.
 */
const T=new Map([[g.SECURITY_CONTEXT_V1_URL,v.get(g.SECURITY_CONTEXT_V1_URL)],[g.SECURITY_CONTEXT_V2_URL,v.get(g.SECURITY_CONTEXT_V2_URL)]]),E={};var x=E;E.extendContextLoader=e=>async t=>{const r=T.get(t);return void 0!==r?{contextUrl:null,documentUrl:t,document:r,tag:"static"}:e(t)},E.strictDocumentLoader=E.extendContextLoader((e=>{throw new Error(`${e} not found.`)}));class b extends Error{constructor(e){super(b._prepareSuperMessage(e)),Object.defineProperty(this,"name",{value:"NonError",configurable:!0,writable:!0}),Error.captureStackTrace&&Error.captureStackTrace(this,b)}static _prepareSuperMessage(e){try{return JSON.stringify(e)}catch{return String(e)}}}const S=[{property:"name",enumerable:!1},{property:"message",enumerable:!1},{property:"stack",enumerable:!1},{property:"code",enumerable:!0}],L=Symbol(".toJSON called"),_=({from:e,seen:t,to_:n,forceEnumerable:i,maxDepth:a,depth:s})=>{const c=n||(Array.isArray(e)?[]:{});if(t.push(e),s>=a)return c;if("function"==typeof e.toJSON&&!0!==e[L])return(e=>{e[L]=!0;const t=e.toJSON();return delete e[L],t})(e);for(const[n,p]of Object.entries(e))"function"==typeof r&&o(p)?c[n]="[object Buffer]":"function"!=typeof p&&(p&&"object"==typeof p?t.includes(e[n])?c[n]="[Circular]":(s++,c[n]=_({from:e[n],seen:t.slice(),forceEnumerable:i,maxDepth:a,depth:s})):c[n]=p);for(const{property:t,enumerable:r}of S)"string"==typeof e[t]&&Object.defineProperty(c,t,{value:e[t],enumerable:!!i||r,configurable:!0,writable:!0});return c};var C={serializeError:(e,t={})=>{const{maxDepth:r=Number.POSITIVE_INFINITY}=t;return"object"==typeof e&&null!==e?_({from:e,seen:[],forceEnumerable:!0,maxDepth:r,depth:0}):"function"==typeof e?`[Function: ${e.name||"anonymous"}]`:e},deserializeError:(e,t={})=>{const{maxDepth:r=Number.POSITIVE_INFINITY}=t;if(e instanceof Error)return e;if("object"==typeof e&&null!==e&&!Array.isArray(e)){const t=new Error;return _({from:e,seen:[],to_:t,maxDepth:r,depth:0}),t}return new b(e)}};
/*!
 * Copyright (c) 2018-2022 Digital Bazaar, Inc. All rights reserved.
 */const M=w,U=n,{extendContextLoader:R,strictDocumentLoader:O}=x,{serializeError:D}=C;function K({document:e}){let t;t=U.getValues(e,"proof");const r=e["@context"]||M.SECURITY_CONTEXT_URL;return t=t.map((e=>({"@context":r,...e}))),t}function A(e){Object.defineProperty(e,"toJSON",{value:function(){return D(this)},configurable:!0,writable:!0})}var N=class extends Error{constructor(e){super("Verification error(s)."),this.name="VerificationError",this.errors=[].concat(e)}},P=class{constructor({type:e}={}){if("string"!=typeof e)throw new TypeError('A LinkedDataProof must have a "type".');this.type=e}async createProof({}){throw new Error('"createProof" must be implemented in a derived class.')}async derive({}){throw new Error('"deriveProof" must be implemented in a derived class.')}async verifyProof({}){throw new Error('"verifyProof" must be implemented in a derived class.')}async matchProof({proof:e}){return e.type===this.type}};
/*!
 ...
 */
const ie={};var ae=ie;const se=w;Object.assign(ie,se);const ce=class{async add(e,{suite:t,purpose:r,documentLoader:o}={}){if(!t)throw new TypeError('"options.suite" is required.');if(!r)throw new TypeError('"options.purpose" is required.');o=o?R(o):O;const n={...e};delete n.proof;const i=K({document:e}),a=await t.createProof({document:n,purpose:r,proofSet:i,documentLoader:o});return U.addValue(e,"proof",a),e}async derive(e,{suite:t,purpose:r,documentLoader:o}={}){if(!t)throw new TypeError('"options.suite" is required.');if(!r)throw new TypeError('"options.purpose" is required.');o=o?R(o):O;const n={...e};delete n.proof;const i=K({document:e});return await t.derive({document:n,purpose:r,proofSet:i,documentLoader:o})}async verify(e,{suite:t,purpose:r,documentLoader:o}={}){if(!t)throw new TypeError('"options.suite" is required.');if(!r)throw new TypeError('"options.purpose" is required.');const n=Array.isArray(t)?t:[t];if(0===n.length)throw new TypeError("At least one suite is required.");o=o?R(o):O;try{const t=K({document:e={...e}});if(0===t.length)throw new Error("No matching proofs found in the given document.");delete e.proof;const i=await async function({document:e,suites:t,proofSet:r,purpose:o,documentLoader:n}){const i=Array.isArray(o)?o:[o],a=new Map,s=new Map,c=new Map;if(await Promise.all(i.map((o=>async function({purposeToProofs:e,proofToSuite:t,purpose:r,proofSet:o,suites:n,suiteMatchQueue:i,document:a,documentLoader:s}){for(const c of o){if(!await r.match(c,{document:a,documentLoader:s}))continue;let o=!1;for(const e of n){let r=i.get(e);r||i.set(e,r=new Map);let n=r.get(c);if(n||(n=e.matchProof({proof:c,document:a,documentLoader:s}),r.set(c,n)),await n){o=!0,t.set(c,e);break}}if(o){const t=e.get(r);t?t.push(c):e.set(r,[c])}}}
/*!
 * Copyright (c) 2020 Digital Bazaar, Inc. All rights reserved.
 */({purposeToProofs:a,proofToSuite:s,purpose:o,proofSet:r,suites:t,suiteMatchQueue:c,document:e,documentLoader:n})))),a.size<i.length)return[];const p=new Map;return await Promise.all([...s.entries()].map((async([t,o])=>{let i;try{let a;const s={validate:async(e,{verificationMethod:t})=>(a=t,{valid:!0})},{verified:c,verificationMethod:p,error:d}=await o.verifyProof({proof:t,document:e,purpose:s,proofSet:r,documentLoader:n});a||(a=p),i={proof:t,verified:c,verificationMethod:a,error:d}}catch(e){i={proof:t,verified:!1,error:e}}i.error&&A(i.error),p.set(t,i)}))),await Promise.all([...a.entries()].map((async([t,r])=>{for(const o of r){const r=p.get(o);if(!r.verified)continue;const{verificationMethod:i}=r,a=s.get(o);let c;try{c=await t.validate(o,{document:e,suite:a,verificationMethod:i,documentLoader:n})}catch(e){c={valid:!1,error:e}}r.purposeResult?Array.isArray(r.purposeResult)?r.purposeResult.push(c):r.purposeResult=[r.purposeResult,c]:r.purposeResult=c,c.valid||(A(c.error),r.error||(r.verified=!1,r.error=c.error))}}))),[...p.values()]}({document:e,suites:n,proofSet:t,purpose:r,documentLoader:o});if(0===i.length){const e=new Error("Did not verify any proofs; insufficient proofs matched the acceptable suite(s) and required purpose(s).");throw e.name="NotFoundError",e}const a=i.some((e=>e.verified));if(!a){const e=[].concat(...i.filter((e=>e.error)).map((e=>e.error))),t={verified:a,results:i};return e.length>0&&(t.error=e),t}return{verified:a,results:i}}catch(e){return A(e),{verified:!1,error:e}}}},pe=N;ie.derive=async function(e,{suite:t,purpose:r,documentLoader:o,addSuiteContext:n=!0}={}){if("object"!=typeof e)throw new TypeError('The "document" parameter must be an object.');t.ensureSuiteContext({document:e,addSuiteContext:n});try{return await(new ce).derive(e,{suite:t,purpose:r,documentLoader:o})}catch(e){if(!o&&"jsonld.InvalidUrl"===e.name){const{details:{url:t}}=e,r=new Error(`A URL "${t}" could not be fetched; you need to pass "documentLoader" or resolve the URL before calling "derive".`);throw r.cause=e,r}throw e}},ie.sign=async function(e,{suite:t,purpose:r,documentLoader:o,expansionMap:n,addSuiteContext:i=!0}={}){if(n)throw new Error('"expansionMap" not supported.');if("object"!=typeof e)throw new TypeError('The "document" parameter must be an object.');t.ensureSuiteContext({document:e,addSuiteContext:i});try{return await(new ce).add(e,{suite:t,purpose:r,documentLoader:o})}catch(e){if(!o&&"jsonld.InvalidUrl"===e.name){const{details:{url:t}}=e,r=new Error(`A URL "${t}" could not be fetched; you need to pass "documentLoader" or resolve the URL before calling "sign".`);throw r.cause=e,r}throw e}},ie.verify=async function(e,{suite:t,purpose:r,documentLoader:o,expansionMap:n}={}){if(n)throw new Error('"expansionMap" not supported.');if("object"!=typeof e)throw new TypeError('The "document" parameter must be an object.');const i=await(new ce).verify(e,{suite:t,purpose:r,documentLoader:o}),{error:a}=i;if(a)if(o||"jsonld.InvalidUrl"!==a.name)i.error=new pe(a);else{const{details:{url:e}}=a,t=new Error(`A URL "${e}" could not be fetched; you need to pass "documentLoader" or resolve the URL before calling "verify".`);i.error=new pe(t)}return i},ie.suites=W.suites,ie.purposes=ne.purposes,Object.assign(ie,x);var de=e(ae);const ue={};
/*!
 * Copyright (c) 2019-2022 Digital Bazaar, Inc. All rights reserved.
 */
const fe="123456789ABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz";function le(e,t){return function(e,t){if(!(e instanceof Uint8Array))throw new TypeError('"input" must be a Uint8Array.');if(0===e.length)return"";let r="",o=0;const n=t.length,i=t.charAt(0),a=[0];for(o=0;o<e.length;++o){let t=e[o];for(let e=0;e<a.length;++e)t+=a[e]<<8,a[e]=t%n,t=t/n|0;for(;t>0;)a.push(t%n),t=t/n|0}for(o=0;0===e[o]&&o<e.length-1;++o)r+=i;for(o=a.length-1;o>=0;--o)r+=t[a[o]];return r}(e,fe)}function he(e){return function(e,t){if("string"!=typeof e)throw new TypeError('"input" must be a string.');if(0===e.length)return new Uint8Array;let r=ue[t];if(!r){r=ue[t]=[];for(let e=0;e<t.length;++e)r[t.charCodeAt(e)]=e}e=e.replace(/\s/g,"");const o=t.length,n=t.charAt(0),i=[0];for(let t=0;t<e.length;t++){const n=r[e.charCodeAt(t)];if(void 0===n)return;let a=n;for(let e=0;e<i.length;++e)a+=i[e]*o,i[e]=255&a,a>>=8;for(;a>0;)i.push(255&a),a>>=8}for(let t=0;e[t]===n&&t<e.length-1;++t)i.push(0);return new Uint8Array(i.reverse())}(e,fe)}export{he as d,le as e,de as j};
