import{d as e,f as t,V as r}from"./main.js";import{j as n,e as o,d as i}from"./index-i8SfJNiU-BwggVbLD.js";import{j as a}from"./jsonld-B5UCaqS7-C61cS9xX.js";import{d as s,e as u}from"./base64url-Cy03LJLt-vkTPfQOh.js";import{f as c}from"./index-BL122gwb-D2vueUR4.js";import{S as f}from"./Suite-B7Vy9AuU-D1ucdMDB.js";import"./pako.esm-DnD5dZGi-Bw1vqMku.js";import"./sha256-BPUIT-9h-C1PUWFZm.js";import"./index-jXPCE-GD-Dgus2xdV.js";import{r as d}from"./retrieveVerificationMethodPublicKey-COeEkq0u-D5MclZgG.js";import"./elliptic-BoxbpLHP-BRLTdj5Y.js";
/*!
...
/*!
 * Copyright (c) 2022-2023 Digital Bazaar, Inc. All rights reserved.
 */({verifier:t,data:e})}}async function Ke({cryptosuite:e,document:t,proof:r,documentLoader:n}){if(e?.name!==Ne)throw new TypeError(`"cryptosuite.name" must be "${Ne}".`);const o={documentLoader:n},i=m({document:t,proof:r,options:o}).catch((e=>e)),{baseSignature:a,publicKey:s,signatures:u,labelMap:c,mandatoryIndexes:f}=await Pe({proof:r}),d=await function({labelMap:e}={}){return async({canonicalIdMap:t})=>{const r=new Map;for(const[n,o]of t)r.set(n,e.get(o));return r}}({labelMap:c}),l=await g({document:t,labelMapFactoryFunction:d,options:o}),p=[],w=[];for(const[e,t]of l.entries())f.includes(e)?p.push(t):w.push(t);const{mandatoryHash:b}=await async function({mandatory:e,hasher:t}={}){return t||(t=h()),{mandatoryHash:await t.hash(y(e.join("")))}}({mandatory:p}),v=await i;if(v instanceof Error)throw v;return{baseSignature:a,proofHash:v,publicKey:s,signatures:u,nonMandatory:w,mandatoryHash:b}}const _e=self&&(self.crypto||self.msCrypto);async function ze({string:e}){const t=(new TextEncoder).encode(e);return new Uint8Array(await _e.subtle.digest("SHA-256",t))}
/*!
 * Copyright (c) 2022-2023 Digital Bazaar, Inc. All rights reserved.
