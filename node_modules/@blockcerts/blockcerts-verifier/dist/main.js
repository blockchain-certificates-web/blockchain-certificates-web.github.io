...
</style>`;const rv=jg((function(e){const{hasCertificateDefinition:t,recipientName:r,certificateTitle:n,issuedOn:i,issueDate:o,issuerName:a,recordLink:s,hideVerifyButton:c}=e;let{hideRecordLink:u}=e;if(!t)return null;s||u||(u=!0);const l=["buv-c-card__title",u?"buv-c-card__title--no-padding":""].join(" ");return oe`
      ${tv}
