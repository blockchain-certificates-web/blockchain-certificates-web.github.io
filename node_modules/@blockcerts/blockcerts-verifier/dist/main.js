...
`:null,{mapStateToProps:e=>({showInput:!og(e)})});window.customElements.define("buv-certificate-input",gm);var mm=oe`<style>.buv-o-button-link{display:block;cursor:pointer;border:0;background-color:transparent}.buv-o-button-link__label{display:block;font-size:13px;cursor:pointer}.buv-o-button-link.is-disabled,.buv-o-button-link:disabled{cursor:help;opacity:.6}.buv-c-download-link{text-decoration:none;color:currentColor}.buv-c-download-link--icon{background-image:url("data:image/svg+xml,%3Csvg%20version%3D%221.1%22%20id%3D%22Capa%5f1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%0A%09%20width%3D%22433.5px%22%20height%3D%22433.5px%22%20fill%3D%22%236e7e8e%22%20viewBox%3D%220%200%20433.5%20433.5%22%20style%3D%22enable-background%3Anew%200%200%20433.5%20433.5%3B%22%20xml%3Aspace%3D%22preserve%22%0A%09%3E%3Cg%3E%3Cg%20id%3D%22file-download%22%3E%3Cpath%20d%3D%22M395.25%2C153h-102V0h-153v153h-102l178.5%2C178.5L395.25%2C153z%20M38.25%2C382.5v51h357v-51H38.25z%22%2F%3E%3C%2Fg%3E%3C%2Fg%3E%3C%2Fsvg%3E");width:17px;height:17px;background-size:17px}.buv-c-download-link.is-disabled{pointer-events:none}.buv-u-visually-hidden{position:absolute !important;clip:rect(1px 1px 1px 1px);clip:rect(1px, 1px, 1px, 1px);padding:0 !important;border:0 !important;height:1px !important;width:1px !important;overflow:hidden}
</style>`;const vm=jg(function({downloadLink:e,display:t=""}){const r="plaintext"===t,n=ng(e?"text.downloadLink":"errors.noDownloadLink"),i=["buv-c-download-link","buv-o-button-link",e?"":"is-disabled",r?"":"buv-c-metadata-link--icon"].join(" ");return oe`
    ${mm}
  ...
  `:null),{mapStateToProps:e=>({allowDownload:Jg(e),allowSocialShare:Gg(e),showMetadata:Xg(e),isVisible:Yg(e)===Mg&&!!og(e)})});window.customElements.define("buv-action-menu",Om);var Tm=oe`<style>.buv-c-verification-modal__process{display:flex;justify-content:space-around}.buv-c-verification-modal__separator{margin-bottom:30px;background-color:rgba(3,21,50,0.05);height:1px;border:0 none}.buv-c-verification-modal__content{max-height:100vh;padding-bottom:43px;box-sizing:border-box;overflow:auto}@media only screen and (max-width: 600px){.buv-c-verification-modal__content{max-height:calc(100vh - 120px)}}
...
</style>`;function Pm(e){return async function(t){t({type:He});const r=await Zp.certificates.read(e);t(rm(JSON.parse(r)))}}const Am=jg(function({onChange:e=(()=>{}),hideFileUpload:t=!1}){return t?null:oe`
    ${Cm}
    ...
    <span class="buv-o-text-12">${ng("text.dragAndDropHint")}</span>`},{mapDispatchToProps:{onChange:Pm},mapStateToProps:e=>({hideFileUpload:og(e)})});function Mm(){return function(e){e($g()),e(function(e){e({type:Ye}),e(Kg(Jp.DEFAULT)),e(Qg(null))}),e({type:Fe,payload:{definition:null}})}}window.customElements.define("buv-file-upload",Am);var Lm=oe`<style>.buv-o-link{cursor:pointer;text-decoration:none;color:currentColor}.buv-o-link__text--underline{border-bottom:1px solid}.buv-o-text-11{font-size:11px}.buv-o-text-12{font-size:12px}.buv-o-text-13{font-size:13px}.buv-o-text-15{font-size:15px;line-height:20px}.buv-c-verify-other-certificate{display:block}
</style>`;const Nm=jg(function({onClick:e=(()=>{}),isVisible:t=!1}={}){return t?oe`
    ${Lm}
  ...
  `:null},{mapDispatchToProps:{onClick:Mm},mapStateToProps:e=>({isVisible:!!og(e)})});window.customElements.define("buv-verify-other-certificate",Nm);var Rm=oe`<style>.buv-o-text-11{font-size:11px}.buv-o-text-12{font-size:12px}.buv-o-text-13{font-size:13px}.buv-o-text-15{font-size:15px;line-height:20px}.buv-c-footer{width:100%;height:60px;background-color:rgba(0,0,0,0.1);color:#031532;fill:#111;display:flex;justify-content:space-between;align-items:center;padding:0 30px;box-sizing:border-box}.buv-c-footer a{line-height:1}.buv-c-footer--dark{color:#fff;fill:#fff}.buv-c-footer--forced{position:absolute;bottom:0;left:0;margin-top:0;justify-content:flex-end}
</style>`,jm=oe`<style>.buv-u-visually-hidden{position:absolute !important;clip:rect(1px 1px 1px 1px);clip:rect(1px, 1px, 1px, 1px);padding:0 !important;border:0 !important;height:1px !important;width:1px !important;overflow:hidden}.buv-c-logo{color:currentColor;text-decoration:none}.buv-c-logo--small{width:113px;height:16px}.buv-c-logo--medium{width:66%}.buv-c-logo__motto{font-size:12px}
</style>`;const Dm=({className:e,showMotto:t=!1}={})=>oe`
  ${jm}
  ...
  `}
  </a>`,Um=jg(({forceInPlace:e=!1,interactive:t=!1,theme:r}={})=>{const n=["buv-c-footer",e?"buv-c-footer--forced":"","dark"===r?"buv-c-footer--dark":""].join(" ");return oe`
  ${Rm}
  <footer class$='${n}'>
    ${t?oe`<section>
  ...
  `},{mapStateToProps:e=>({finalStep:Tg(e),chain:vg(e),transactionLink:gg(e),isTestChain:yg(e),status:$m(e)}),ownProps:{isVisible:Boolean,hideLink:Boolean,standalone:Boolean}});window.customElements.define("buv-final-verification-step",Wm);var Jm=oe`<style>.buv-o-text-11{font-size:11px}.buv-o-text-12{font-size:12px}.buv-o-text-13{font-size:13px}.buv-o-text-15{font-size:15px;line-height:20px}.buv-o-link{cursor:pointer;text-decoration:none;color:currentColor}.buv-o-link__text--underline{border-bottom:1px solid}.buv-c-substeps-list__link::after{content:'';width:0;height:0;border-left:4px solid transparent;border-right:4px solid transparent;border-bottom:4px solid #768087;display:inline-block;vertical-align:2px;margin:0 6px;-webkit-transition:-webkit-transform .3s ease-in;-o-transition:transform .3s ease-in;transition:transform .3s ease-in}.buv-c-substeps-list__link.is-open::after{transform:rotate(180deg)}.buv-c-substeps-list__list{max-height:0;overflow:hidden;-webkit-transition:max-height .3s ease-in;-o-transition:max-height .3s ease-in;transition:max-height .3s ease-in;padding-left:50px;margin-left:-50px;padding-top:5px}.buv-c-substeps-list__list.is-open{height:auto}
    ...
    `}});var Gm=oe`<style>.buv-c-verification-process{position:relative}.buv-c-verification-progress-bar{position:absolute;left:13px;top:0;width:14px;display:flex;flex-direction:column;height:100%}.buv-c-verification-progress-bar__tube{min-height:14px;transition:flex .4s ease-in-out, max-height .4s ease-in;background-color:#2ab27b;border-radius:7px;flex-grow:0;opacity:0}.buv-c-verification-progress-bar__tube.has-started{flex-grow:1;opacity:1}.buv-c-verification-progress-bar__tube.is-test{background-color:#d8d8d8}.buv-c-verification-progress-bar__tube.has-errored{background-color:#d0021b}.buv-c-verification-progress-bar.no-transition{-webkit-transition:none;-moz-transition:none;-o-transition:none;transition:none}.buv-c-verification-process__step-list{padding-left:46px;margin-top:0}.buv-u-visually-hidden{position:absolute !important;clip:rect(1px 1px 1px 1px);clip:rect(1px, 1px, 1px, 1px);padding:0 !important;border:0 !important;height:1px !important;width:1px !important;overflow:hidden}
    ...
    `}_didRender(){this.listElement||(this.listElement=this.shadowRoot.querySelectorAll(".buv-js-verification-process__step-list")[0])}_render({steps:e,transactionLink:t,hasError:r,isTestChain:n}){const i=e.filter(e=>e.status!==Jp.DEFAULT).map((e,t)=>oe`
      ${Vm({...e,isParent:!0,isFirst:0===t,isTestChain:n})}
  ...
  `}});const Xm=jg(function({steps:e,transactionLink:t,hasError:r,isTestChain:n}){return oe`<buv-verification-process-raw
    steps='${e}'
    hasError?='${r}'
    isTestChain?='${n}'
    style='max-width: 100%;'
    ></buv-verification-process-raw>`},{mapStateToProps:e=>({steps:JSON.parse(JSON.stringify(wg(e))),isTestChain:yg(e),hasError:xg(e)})});window.customElements.define("buv-verification-process",Xm);const Ym=jg(function({isOpen:e,onClose:t}){return oe`
    ${Tm}
  ...
  `},{mapDispatchToProps:{onClose:tm.bind(null,!1)},mapStateToProps:e=>({isOpen:Km(e)})});window.customElements.define("buv-verification-modal",Ym);var Zm=oe`<style>.buv-o-text-11{font-size:11px}.buv-o-text-12{font-size:12px}.buv-o-text-13{font-size:13px}.buv-o-text-15{font-size:15px;line-height:20px}.buv-c-drag-and-drop__droparea{z-index:100;background-color:rgba(0,0,0,0.1);display:none;position:absolute;top:0;left:0;width:100%;height:100%}.buv-c-drag-and-drop__droparea.is-active{display:block}
  ...
  `},{mapStateToProps:e=>({hasCertificateDefinition:!!og(e),certificateImage:kg(e),certificateTitle:ug(e),certificateSubtitle:Sg(e),certificateDescription:Eg(e),certificateSeal:Og(e),certificateSignatures:Ig(e),recipientName:cg(e),issuerName:lg(e)})});window.customElements.define("buv-full-certificate-v1",lv);const fv=jg(function({hasCertificateDefinition:e,displayHTML:t}){return e?oe`
    ${iv}
    ${t?function(e){return oe`<section class='buv-c-full-certificate qa-full-certificate'>${nv(e)}</section>`}(t):oe`<buv-full-certificate-v1></buv-full-certificate-v1>`}
    ...
    <section class='buv-c-fullscreen-certificate'>
      ...
      <section class='buv-c-fullscreen-certificate__content'>
        <div class='buv-c-fullscreen-certificate__details'>
          ...
          ${Dm({className:"buv-c-fullscreen-certificate__separator",showMotto:!0,logoSize:"medium"})}
  ...
  `:null},{mapDispatchToProps:{onClose:Mm},mapStateToProps:e=>({recipientName:cg(e),hasCertificateDefinition:!!og(e),displayHTML:dg(e)})});window.customElements.define("buv-fullscreen-certificate",hv);class pv extends le{constructor(){super(),this.hasRenderedOnce=!1}static get properties(){return{onLoad:Function,errorMessage:String,hasCertificate:Boolean,...sm}}_firstRendered(){this.onLoad(this._props),this.hasRenderedOnce=!0}_propertiesChanged(e,t,r){this._props=e,super._propertiesChanged(e,t,r),t.src!==r.src&&this.hasRenderedOnce&&this.onLoad({src:t.src})}renderCertificate(e){switch(e.displayMode){case Mg:return oe`<buv-full-certificate></buv-full-certificate>`;case Lg:return oe`<buv-fullscreen-certificate></buv-fullscreen-certificate>`;default:return oe`<buv-card-certificate></buv-card-certificate>`}}_render(e){const t=e.hasCertificate?"buv-c-verifier-body  buv-c-verifier-body--padded":"";return oe`
    ...
    `}}function bv(e){return e.errorMessage}window.customElements.define("buv-raw",pv);const gv=jg(function(e={}){return oe`<buv-raw
          src='${e.src}'
          onLoad='${e.onLoad}'
          ...
          theme='${e.theme}'
          locale='${e.locale}'
        ></buv-raw>`},{mapDispatchToProps:{onLoad:function(e={}){return function(t){const r=function(e){return Object.keys(sm).reduce((t,r)=>(e[r]&&(t[r]=e[r]),t),{})}(e);t({type:Be,payload:{options:r}}),r.src&&t(nm(r.src)),um(r.locale)}}},mapStateToProps:e=>({errorMessage:bv(e),hasCertificate:!!og(e)}),ownProps:{...pv.properties,...am}});window.customElements.define("blockcerts-verifier",gv)}();
